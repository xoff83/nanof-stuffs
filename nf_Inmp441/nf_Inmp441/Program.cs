...
namespace nf_Inmp441
{
    public class Program
    {
        ...
        * La solution compléte INMP441 se compose d'un capteur MEMS, d'un conditionnement de la composition du signal, d'un convertisseur analogique-numérique, 
        * d'un filtre anti-crénelage, d'une gestion de l'alimentation et d'une interface ié 24 bits standard de l'industrie. L'interface i²s permet à INMP441 
        * de se connecter directement aux processeurs numériques, tels que DSPs et microcontréleurs, sans avoir besoin du codec audio utilisé dans le systéme. 
